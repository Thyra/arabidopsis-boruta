...
data$color = col.darkblue
data[data$Treatment == "D",]$color = col.orange
...
plants.without.flowers = c(
  "1745AJ140",
  "1745AJ175", # in this one also 1 rosettenblatt was entferned
  "1745AJ226",
  "1745AJ254",
  "1745AJ269",
  "1745AJ273",
...
par(family="serif", cex=0.85, mar=c(4,3.3,0,0))
...
for(p in unique(data$Plant.ID)) {
 ...
 # points(max(plant_data$DAS), plant_data[plant_data$DAS == max(plant_data$DAS),]$top.geometry.vis.area.norm..mm.2.)
}
...
text(28, -50, "Drought Stressed Plants", pos=2, col=col.orange, cex=0.6)
text(28, 570, "Well Watered Plants", pos=2, col=col.darkblue, cex=0.6)
